...
<div class="row">
    <div class="col-md-3 col-lg-3">
        <div class="form-group" style="padding:5px;">
            <label for="codbarras" class="form-label">C&oacute;digo de Barras (25 caracteres)</label>
            <input type="text" id="codbarras" name="codbarras" class="form-control form-control-sm" maxlength="30" onkeydown="verificarEnter(event)" value="{{ old('codbarras', $expediente->codbarras ?? '') }}" {{ isset($expediente) ? 'readonly' : '' }}>
...
<div class="row">
    ...
    <div class="col-md-6 col-lg-6">
        <div class="form-group" style="padding:5px;">
            <label for="agraviado" class="form-label">Agraviado</label>
            ...
            <label for="delito" class="form-label">Delito</label>
			  ...
			  <select name="delito" id="delito" class="">
			          ...
			          @foreach($delitos as $p)
			              <option value="{{ $p->id_delito }}" {{ old('id_delito', $expediente->delito ?? '') == $p->id_delito ? 'selected' : '' }}>
			                  {{ $p->desc_delito }} 
			              </option>
			          @endforeach
                          </select>
...
<div class="row">
    <div class="col-md-2 col-lg-2">
        <div class="form-group" style="padding:5px;">
            <label for="nro_folios" class="form-label">Folios</label>
