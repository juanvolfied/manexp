...
<div class="row">
    <div class="col-md-3 col-lg-3">
        <div class="form-group" style="padding:5px;">
            ...
            <input type="text" id="codescrito" name="codescrito" class="form-control form-control-sm" maxlength="11" value="{{ old('codescrito', $libroescritos->codescrito ?? '') }}" @if(isset($libroescritos)) disabled @endif  onkeydown="verificacodbar(event)" onblur="this.value = this.value.toUpperCase()">
