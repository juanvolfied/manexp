...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-title">Consulta de cargos por escritos entregados</div>
        </div>
    ...
    <form id="form-filtros" class="row g-3" autocomplete="off">
        ...
        <div class="col-md-2 d-flex align-items-center">
            <a href="#" onclick="abrirCalendario()" class="btn btn-primary w-100"><i class="fas fa-calendar-alt fa-lg me-1"></i> Mostrar Cargo(s)</a>
        </div>
...
function cambiar(pdfcal) {
    let pdfUrl = `../../storage/app/mesapartescargos/`+ pdfcal +`.pdf?v=${Date.now()}`;
