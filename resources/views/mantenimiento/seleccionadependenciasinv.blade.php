...
<head>
    ...
    <title>Selecciona Dependencias mostradas en Inventario</title>    
</head>
<body>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <div class="card-title">Selecciona dependencias mostradas en Inventario</div>
                  </div>
        ...
        <table id="tablaseguimiento" class="table table-striped table-bordered">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th style="padding: 5px 10px!important; font-size: 11px !important; text-transform:none;" align="center">Ver Inventario</th>
                </tr>
            </thead>
            <tbody>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('.toggle-inventario').forEach(function (checkbox) {
            checkbox.addEventListener('change', function () {
                ...
                const urlTemplate = "{{ route('dependenciacambiaestado', ['id' => '__ID__']) }}";
