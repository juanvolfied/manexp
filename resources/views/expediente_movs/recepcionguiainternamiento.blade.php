            ...
            <tbody id="tabla-codigos">
                ...
                @endforeach
                  ...
                  <div class="card-footer">
                    <a href="{{ route('internamiento.recepcion') }}" class="btn btn-secondary">Regresar a pantalla anterior</a>
                    <a href="#" onclick="prepararYMostrarModal('{{ $guiacab->tipo_mov }}',{{ $guiacab->ano_mov }},{{ $guiacab->nro_mov }},event)" class="btn btn-primary">RECEPCI&Oacute;N TOTAL</a>
