...
<head>
    ...
    <title>Verificaci&oacute;n para Recepci&oacute;n de Carpetas Fiscales devueltas</title>    
  </head>
<body>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <div class="card-title">Carpetas fiscales a recepcionar por devoluci&oacute;n</div>
                  </div>
                  <div class="card-body">
            ...
            <tbody id="tabla-codigos">
                ...
                @endforeach
                  ...
                  <div class="card-footer">
                    ...
                    <a href="#" onclick="prepararYMostrarModal('{{ $guiacab->tipo_mov }}',{{ $guiacab->ano_mov }},{{ $guiacab->nro_mov }},event)" class="btn btn-primary">RECEPCIONAR CARPETAS DEVUELTAS</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="textoModalLabel">CONFIRMAR RECEPCION</h5>
...
function recepcionarDevolucion(event) {
    ...
    myModal.hide();
        ...
        $.ajax({
            url: '{{ route("devolucion.grabarecepcion") }}', 
            method: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
                tipo_mov: tipo,
