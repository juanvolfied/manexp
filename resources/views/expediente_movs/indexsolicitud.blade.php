...
//    $estados = ['G' => 'Generado', 'E' => 'Enviado', 'R' => 'Recepcionado', 'Z' => 'RECHAZADO'];
    $estados = ['G' => 'Generado', 'S' => 'Solicitado', 'E' => 'Enviado', 'R' => 'Recibido', 'Z' => 'RECHAZADO'];
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        DESEA CONTINUAR CON EL ENVIO DE LA SOLICITUD DE CARPETAS FISCALES?
      </div>
      ...
      <div class="modal-footer">
        ...
        <a href="#" onclick="enviarsolicitud(event)" class="btn btn-primary">Enviar a Archivo</a>
