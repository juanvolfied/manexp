...
<head>
    <meta charset="utf-8">
    <title>Solicitar Veh&iacute;culo</title>
</head>
<!--
<div class="card" style="margin-bottom: 10px;">
    <div class="card-header d-flex justify-content-between align-items-center">
    <div class="card-title">Solicitar y agendar uso de veh&iacute;culo para diligencia</div>
    </div>
    <div class="card-body">
            ...
            <div class="row" id="datacabe">
              ...
              <div class="col-md-12">
                <div class="card">
                  ...
                  <div class="card-header  d-flex justify-content-between align-items-center">
                    <div class="card-title">Solicitar uso de Vehículo</div>
    <button class="btn btn-primary mb-0" data-bs-toggle="modal" data-bs-target="#eventModal">
    <i class="fas fa-hand-paper fa-lg"></i> Generar Nueva Solicitud
    </button>                        
                  </div>
                    ...
                    <ul class="nav nav-tabs card-header-tabs" id="tabsCard" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="tab1-tab" data-bs-toggle="tab" data-bs-target="#tab1"
                                ...
                                <b>SOLICITUDES REALIZADAS POR DESPACHO ACTUAL</b>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
...
<td 
    ...
    "
><b>
    {{ $p->estado === 'S' ? 'En espera' : ($p->estado === 'A' ? 'Agendado' : $p->estado) }}
</b></td>
                        </tr>
                    @endforeach
                </tbody>
...
<div class="modal fade" id="eventModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog" style="max-width: 65vw; width: 65vw;">
    <form id="formCreateEvent" class="modal-content" autocomplete=off>
        @csrf
      <div class="modal-header">
        <h5 class="modal-title">Nueva solicitud de vehículo</h5>
...
document.getElementById('tab2-tab')
    ...
    form.addEventListener('submit', async (e) => {
        ...
        const response = await fetch('/manexp/public/grabarsolicitud', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
